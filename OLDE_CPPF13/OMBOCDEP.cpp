...
int main(){
	...
	for(f = 1;f <= 13;f++){
		char filename[100];
		sprintf(filename,"/home/ryan/testdataNew/data_Scale%.1lf/OMBOCP2013WC%.1lf/outputc%d.txt",Genotype::SCALE,Genotype::PXOVER,f);
